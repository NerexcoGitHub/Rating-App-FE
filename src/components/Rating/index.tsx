...
const RatingModel = () => {
  ...
  return (
    <section className="text-black bg-dark-blue bg-gradient-to-b from-[#fd9a44] to-[#ffffff] min-w-[300px] max-w-[500px] h-[420px] sm:w-[450px] m-8 rounded-xl sm:rounded-3xl p-8 flex flex-col gap-4 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50">
      {submited ? (
...
const SelectRating = (props: {
  ...
  <>
    <div className="bg-white rounded-full w-max p-4">
      <img src="/assets/icon-star.svg" alt="Star icon" className="opacity-100"></img>
    </div>
